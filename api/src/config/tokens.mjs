...
export const SUPPORTED_TOKENS = {
  ...
  WTVARA: {
    ...
    name: 'Wrapped VARA',
    decimals: 12,
    vara: process.env.WVARA_TOKEN_ID || '0xf5e9cb1d1e46b0cda6578dd1684b30f281a45dfaa390e4945b7bfc8ab3e27f3d',
  ...
  gVARA: {
    ...
    decimals: 12,
    vara: process.env.GVARA_TOKEN_ID || '0x04314af41b7dbac322e3e66920211d2f799719e1cdc3122a99752f72b6ae84ee',
    eth: null,
    underlying: 'VARA',
    icon: '/tokens/vara.svg',
    category: 'native',
