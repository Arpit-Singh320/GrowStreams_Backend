...
export async function migrate() {
  ...
  // Seed / upsert default quests. Set active=FALSE for legacy quests to prevent reactivation on deploy.
  await p.query(`
    INSERT INTO quests (slug, title, description, quest_type, seeds_reward, icon, repeatable, active, sort_order, meta) VALUES
      ('welcome-bonus',          'Join the GrowStreams Quest',                         'Welcome to GrowStreams Quests! You receive 100 Seeds just for joining. One-time reward.',                                                                                     'WELCOME',          100, 'gift',             FALSE, FALSE,  0, '{}'),
      ('follow-x',               'Follow GrowStreams on X',                            'Follow @growwstreams on X, then submit your X username for review. Refreshes weekly.',                                                                                        'X_FOLLOW',         100, 'twitter',          TRUE,  FALSE,  1, '{"target_handle": "growwstreams"}'),
      ('mention-x',              'Post about GrowStreams',                             'Post a tweet mentioning @growwstreams with your wallet address, then paste the tweet URL for admin review. Refreshes weekly.',                                                 'X_MENTION',        150, 'megaphone',        TRUE,  FALSE,  2, '{}'),
      ('follow-x-ginie',         'Follow @giniedev on X',                             'Follow our partner @giniedev on X to stay updated on the GrowStreams x Ginie collab.',                                                                                        'X_FOLLOW',         100, 'twitter',          FALSE, FALSE,  3, '{"target_handle": "giniedev"}'),
      ('mention-x-ginie',        'Post about Ginie',                                  'Post a tweet mentioning @giniedev with your wallet address, then paste the tweet URL for admin review. Refreshes weekly.',                                                    'X_MENTION',        200, 'megaphone',        TRUE,  FALSE,  4, '{}'),
      ('star-repo',              'Star the GrowStreams repo',                          'Star the GrowStreams repository on GitHub. Refreshes weekly.',                                                                                                                 'GITHUB_STAR',      100, 'star',             TRUE,  FALSE,  5, '{}'),
      ('raise-pr',               'Raise a PR on GrowStreams repo',                    'Open a pull request on the GrowStreams GitHub repository. Refreshes weekly.',                                                                                                  'GITHUB_PR',        200, 'git-pull-request', TRUE,  FALSE,  6, '{}'),
      ('create-stream',          'Create a stream on GrowStreams',                    'Create a token stream on the GrowStreams mainnet application. Refreshes weekly.',                                                                                              'ONCHAIN_STREAM',   100, 'waves',            TRUE,  FALSE,  7, '{}'),
      ('retweet-campaign',       'Retweet + Like the GrowStreams campaign post',       'Retweet and like the official GrowStreams campaign announcement. Paste the URL of your retweet to verify.',                                                                   'X_RETWEET',        150, 'repeat',           FALSE, FALSE,  8, '{}'),
      ('tweet-build-growstreams','Tweet what you want to build with GrowStreams',      'Write an original public tweet (min 30 chars) mentioning @GrowStreams with the word "build". Paste your tweet URL to submit.',                                               'X_TWEET_KEYWORD',  300, 'edit',             FALSE, FALSE,  9, '{"required_mention": "@GrowStreams", "required_keyword": "build", "min_length": 30}'),
      ('visit-platform',         'Visit GrowStreams and explore the platform',        'Head over to growstreams.xyz, explore the dashboard and streams. Click Claim once done.',                                                                                      'VISIT_URL',         15, 'globe',            FALSE, FALSE, 10, '{"url": "https://growstreams.xyz"}'),
      ('join-telegram',          'Join the GrowStreams Telegram Community',           'Join our official Telegram group to connect with builders in the GrowStreams ecosystem.',                                                                                      'TELEGRAM_JOIN',     10, 'send',             FALSE, FALSE, 11, '{"url": "https://t.me/growstreams"}'),
      ('refer-a-friend',         'Refer a Friend to GrowStreams',                     'Share your personal referral code. Every time someone registers with it, you earn 200 Seeds. No weekly cap — every referral counts, forever.',                              'REFERRAL',         200, 'users',            TRUE,  FALSE, 12, '{}')
