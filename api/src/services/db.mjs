  ...
  if (parseInt(questCount?.cnt || '0', 10) === 0) {
    await p.query(`
      INSERT INTO quests (slug, title, description, quest_type, seeds_reward, icon, repeatable, sort_order) VALUES
        ('follow-x',       'Follow @growwstreams on X',             'Follow the official GrowStreams account on X (Twitter).',          'X_FOLLOW',        100, 'twitter',    FALSE, 1),
        ('mention-x',      'Post on X mentioning @growwstreams',    'Create a post on X that mentions @growwstreams.',                   'X_MENTION',       150, 'megaphone',  FALSE, 2),
